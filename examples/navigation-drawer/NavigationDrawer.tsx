...
function NavigationDrawer() {
  ...
  const gesture = Gesture.Pan()
    ...
    .onUpdate((e) => {
      ...
      if (startedFromEdge || isClosing) {
        const newX = isOpen 
          ...
          : Math.max(-DRAWER_WIDTH, Math.min(0, -DRAWER_WIDTH + e.translationX));
    ...
    .onEnd((e) => {
      ...
      const shouldOpen = translateX.value > -DRAWER_WIDTH / 2 || 
        ...
        <Animated.View style={[styles.content, contentStyle]}>
          ...
          <View style={styles.mainContent}>
            ...
            <Text style={styles.contentText}>
              ...
              The drawer predicts your intent and starts opening before you finish the gesture!
            </Text>
        ...
        <GestureDetector gesture={gesture}>
          <Animated.View style={[styles.drawer, drawerStyle]}>
            ...
            <View style={styles.swipeIndicator}>
              <View style={[
                styles.swipeBar,
                willOpen && styles.swipeBarActive,
              ]} />
            </View>
          </Animated.View>
        </GestureDetector>
